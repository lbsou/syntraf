...
| :------------- |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :----------: |
|IPERF3_BINARY_PATH| Full path to iperf3 binary<br/>Example : ```"c:\\tools\\iperf3.exe"```<br/>Note : Use the double backslash only for Windows. Also you must install a recent version of iperf3. See the notes [here](#install-latest-version-of-iperf)                                                                                                                                                       |AUTODETECT IN $PATH|
...
| :------------- | :---------- | :----------: |
|UID|Unique identification (A-Za-z0-9_-) |NONE|
|IP_ADDRESS|The IPv4 address of this client<br/>Used as identification mechanism in combination with the token (authentication) provided by the client.|NONE|
